...
<!-- gợi ý: Chỉ tên biến, ý nghĩa, khác biệt giữa môi trường và nơi giữ giá trị thật. KHÔNG ghi giá trị secret: dòng KEY=value với value không phải placeholder <...> là lỗi dk check env-no-secret. Quy tắc này là lớp phụ, không thay công cụ quét secret của dự án. -->
