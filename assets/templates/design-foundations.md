...
<!-- gợi ý: mục 1 là frontmatter. Lớp 0 của Design system, áp cho mọi lớp trên. Soạn sau tokens.json và trước atoms. source: Design brief đã duyệt. ui_library: tên thư viện UI dùng sẵn (MUI, Ant, shadcn) nếu có; khi đó mục 2 đến 5 chỉ ghi ngoại lệ so với thư viện. Mọi giá trị hiển thị tham chiếu token ở tokens/tokens.css, không gõ tay. -->

## 2. Thang và semantic tokens
...
## 6. Giọng văn giao diện

<!-- gợi ý: cách gọi người dùng, thì, độ dài; mẫu câu cho thành công, lỗi, rỗng, xác nhận xóa; thống nhất với Glossary mục 3 -->
