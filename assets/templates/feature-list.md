...
<!-- gợi ý: Mô tả một câu, người dùng làm được gì. Nhóm khớp mục 4. Ưu tiên: must | should | could | won't. Nguồn: mục brief hoặc idea sinh ra dòng này (brief §1, brief §4, idea §8). Spec: mã F-xxx khi đã có, để trống khi chưa. -->
